...
public class JwtUtil {
    ...
    private String SECRET_KEY="ABCDEFG";//appProperties.getTokenSecret();
    ...
    public String passwordResetToken(Map<String,Object> claims, String subject)
    {
        return Jwts.builder().setClaims(claims).setSubject(subject).setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis()+1000*60*60))//one day
                .signWith(SignatureAlgorithm.HS256,SECRET_KEY).compact();
    }
